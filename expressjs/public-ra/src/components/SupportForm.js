        ...
        <div className="col-lg-6 mt-3">
            <form method="POST" className="text-center border border-light p-5 rounded bg-blue">
                ...
                <select name="supportType" className="browser-default custom-select mb-4" required>
                    <option className="d-none" defaultValue>Support Type*</option>
                ...
                <input type="text" name="sendType" placeholder="Send Type*" required className="form-control mb-4"></input>
