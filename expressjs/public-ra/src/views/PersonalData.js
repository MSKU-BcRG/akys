...
class PersonalData extends React.Component {
    ...
    componentDidMount() {
        const url = 'http://localhost:8080/api/getdatahash/' + this.state.operationId + '';
                ...
                <div className="row">
                    <div className="col-lg-12 mt-3 mx-auto">
                        <form method="POST" className="text-center border border-light p-5 rounded bg-blue">
                            <p className="h1 mb-4">Personal Data Form</p>
                            <div className="row">
                                ...
                                <div className="col-lg-6 mt-3">
                                    ...
                                    <p className="m-0 p-0">Brief Explanation of Urgency</p>
                            ...
                            <Link to="/needs" className="btn btn-danger btn-block mt-3 w-50 mx-auto">Back</Link>
                        </form>
                    </div>
                </div>
            </div>
